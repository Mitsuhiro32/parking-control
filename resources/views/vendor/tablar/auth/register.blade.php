            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group input-group-flat">
                        <input type="password" name="password_confirmation"
                            class="form-control @error('password_confirmation') is-invalid @enderror" placeholder="Contraseña"
                            autocomplete="off">
                        <span class="input-group-text">
                            <a href="#" class="link-secondary" title="Mostrar contraseña"
                                data-bs-toggle="tooltip"><!-- Descargar icono SVG de http://tabler-icons.io/i/eye -->
                ...
                <div class="mb-3">
                    <label class="form-check">
                        ...
                        <span class="form-check-label">Acepto los <a href="#" tabindex="-1">términos y
                                condiciones</a>.</span>
                    </label>
                </div>
